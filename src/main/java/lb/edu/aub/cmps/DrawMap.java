...
public class DrawMap implements DrawMapInterface {
	...
	public boolean drawMap(Set<String> locations_names){
		...
		Set<Location> locations=coord.getLocations();
	 ...
	 **/
	private boolean createHTMLFile(Set<Location> locations){
	 ...
	 */
	private boolean printInitializationFunction(Set<Location> locations){
		try{
